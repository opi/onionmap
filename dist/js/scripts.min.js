...
function fetchJSONFile(a,e){var t=new XMLHttpRequest;t.onreadystatechange=function(){if(4===t.readyState&&200===t.status){var a=JSON.parse(t.responseText);e&&e(a)}},t.open("GET",a),t.send()}var map=L.map("map").setView([27,18],2);L.tileLayer("http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png",{attribution:'Map tiles by<a href="http://cartodb.com/attributions#basemaps">CartoDB</a>, under <a href="https://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>. Data by <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>, under ODbL.',minZoom:1,maxZoom:10}).addTo(map),L.control.scale({position:"bottomleft",metric:!0,imperial:!1,updateWhenIdle:!0}).addTo(map),map.getContainer().classList.add("loading"),L.Icon.Default.imagePath="dist/css/images";var jsonPath="https://onionoo.torproject.org/details?fields=nickname,fingerprint,latitude,longitude,consensus_weight_fraction,guard_probability,middle_probability,exit_probability,dir_address,country,country_name,as_number,as_name";fetchJSONFile(jsonPath,function(a){map.getContainer().classList.remove("loading"),document.getElementById("relay-count").innerHTML=a.relays.length,relaysMarkers=L.featureGroup(),a.relays.forEach(function(a,e){if(a.latitude&&a.longitude){var t=L.marker([a.latitude,a.longitude]).bindPopup("<h3>"+a.nickname+"</h3><p><a href='https://atlas.torproject.org/#details/"+a.fingerprint+"'>"+a.fingerprint+"</a></p><p>Country: "+a.country_name+" ("+a.country+")<br />AS Number: "+a.as_number+"<br />AS Name: "+a.as_name+"<br />Consensus weight fraction: "+a.consensus_weight_fraction+"<br />Guard probability: "+a.guard_probability+"<br />Middle probability: "+a.middle_probability+"<br />Exit probability: "+a.exit_probability+"<br /></p>");relaysMarkers.addLayer(t)}});var e=new L.MarkerClusterGroup({showCoverageOnHover:!0,polygonOptions:{stroke:!1,opacity:.2,fillColor:"#885CA4",fillOpacity:.1},maxClusterRadius:60});e.addLayer(relaysMarkers),map.addLayer(e)});